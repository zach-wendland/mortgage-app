...
export default {
  ...
  computed: {
    summaryCards() {
      ...
      const interestPercentage = (this.results?.totalPaid && this.results.totalPaid > 0 && this.results?.totalInterest)
      ...
      cards.push({
        label: 'Loan Amount',
        prefix: '$',
        rawValue: this.loanInfo?.principal ?? 0,
        isNumber: true,
        decimals: 2,
        glass: true
      });
      ...
      if (this.loanInfo?.includeSalesTax) {
        cards.push({
          ...
          prefix: '$',
          rawValue: this.loanInfo?.financedPrincipal ?? 0,
          isNumber: true,
          decimals: 2,
          glass: true
        });
      ...
      cards.push({
        label: 'Loan Term',
        rawValue: this.loanInfo?.years ?? 0,
        suffix: ' years',
        isNumber: true,
        decimals: 0,
        glass: true,
      ...
      if (this.loanInfo?.includeSalesTax && this.loanInfo?.stateCode) {
        cards.push({
          ...
          rawValue: (this.loanInfo?.taxRate ?? 0) * 100,
          suffix: '%',
          isNumber: true,
          decimals: 2,
          glass: true,
      ...
      if (this.loanInfo?.includeSalesTax) {
        cards.push({
          ...
          prefix: '$',
          rawValue: this.loanInfo?.taxAmount ?? 0,
          isNumber: true,
          decimals: 2,
          glass: true
        });
      ...
      // Total Interest
      const principalPercentage = (this.results?.totalPaid && this.results.totalPaid > 0 && this.loanInfo?.principal)
